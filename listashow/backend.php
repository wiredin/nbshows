...
while(!empty($_POST['band_name'][$bandCount])){
    $query = "INSERT INTO `bands` (`band_name`,`website`,`location`) VALUES('".$escpMe->$_POST['band_name'][$bandCount]."','".$escpMe->$_POST['band_website'][$bandCount]."','".$escpMe->$_POST['band_location'][$bandCount]."');";
    mysql_query($query);
